 ...
 */
if(defined('APP_NAME')!='GZphp' && !defined("GZPHP"))  exit("Access Denied");
		...
		if(!$this->userid){
			if($this->isadmin){
				...
				if($_COOKIE['GZ_auth']){
					...
					$HTTP_USER_AGENT = strstr($_SERVER['HTTP_USER_AGENT'],'Flash') ? $_COOKIE['GZ_cookie'] : $_SERVER['HTTP_USER_AGENT'];
